...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tạo mới module</h3>          
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <a href="{{ url('/module') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                ...
                <form method="POST" action="{{ url('/module') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                    @include ('module.form', ['formMode' => 'create'])
                    </div>
                </form>
          </div>
@stop
